/**
 * Zepresso — ürün/hero görsel sahnesi üreticisi (paylaşılan çekirdek).
 *
 * `scripts/generate-art.mjs` (toplu CLI) ve admin panelin
 * "SVG'yi yeniden oluştur" uç noktası (`src/app/api/admin/products/[id]/regenerate-art`)
 * aynı sahne üretim mantığını burdan paylaşır — iki yerde de aynı görsel
 * çıktı garanti edilir.
 */
